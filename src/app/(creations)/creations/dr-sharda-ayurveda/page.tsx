...
import ImgComp from '@/components/workCompo/imgComp'
...
export default function CreationPage(){
    ...
    return(
        <main className="mt-[10vw] flex justify-center items-center overflow-y-auto">
            <div className="w-[1200px] flex flex-col">
                ...
                <div className="">
                    ...
                    <ImgComp
                        ...
                        altText="A beautiful landscape"
                        className="w-[100%] rounded-[20px] shadow-xl"  
                    />
                </div>
            </div>
        </main>
