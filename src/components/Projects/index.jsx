...
const projects = [
  ...
  },
  {
    ...
    para: "SEO Opimization",
    color: "#EFE8D3"
  },
  {
    title: "Amlplifbrands",
    src: "amplifbrands.png",
    para: "Development & SEO",
    color: "#706D63"
  }
]
...
export default function Home() {
  ...
  <main onMouseMove={(e) => {moveItems(e.clientX, e.clientY)}} className={styles.projects}>
    ...
    {/* <RoundBTN>
      <p>More Creations</p>
      <div className={styles.upperNo}>11</div>
    </RoundBTN> */}
    <>
  ...
  useLayoutEffect(() => {
    gsap.fromTo(
      ...
      },
      {
        ...
        scrollTrigger: {
          trigger: ref.current,
          start: 'top 90%', // Animation starts when the top of the element is at 80% of the viewport
