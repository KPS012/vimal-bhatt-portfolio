    ...
    >
      <div className='relative h-[calc(100vh+800px)] -top-[100vh]'>
        <div className='h-[800px] sticky top-[calc(100vh-800px)] flex flex-col justify-center items-center'>
          ...
          <Link
            href={Url}
            className="mt-[10vh] w-[80vw] flex flex-col justify-center items-center"
          ...
          >
            ...
            <h3 className="mt-[4vh] text-[10vh] font-[600] text-[#141516]">
              {H3}
            </h3>
          ...
          <div 
            ...
            <div className="w-[80vw] py-4 flex justify-between items-center">
              ...
              <p className="text-[#141516]">Social Icons</p>
            </div>
          </div>
